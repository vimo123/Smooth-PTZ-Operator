...
## Smooth PTZ Operator edition

This edition adds temporal smoothing with a fixed response time of **250 ms**:

- left stick: smooth coarse pan and tilt
- right stick: smooth fine pan and tilt; it takes priority while active
- LT / RT: smooth manual zoom
- gentle acceleration and deceleration when controls are moved or released

All existing button mappings, presets, automatic zoom buttons, iris and focus
controls remain unchanged.

Based on the original [`krupper/ptz-control`](https://github.com/krupper/ptz-control)
project.
